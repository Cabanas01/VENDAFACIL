...
import { ChefHat, Clock, History, Loader2, MapPin, Users, CheckCircle2, AlertTriangle } from 'lucide-react';
...
export default function CozinhaPage() {
  ...
  const handleMarkReady = async (itemId: string) => {
    try {
      ...
      toast({ title: 'Item Pronto!', description: 'O pedido foi marcado como concluído.' });
      fetchPedidos();
    } catch (err: any) {
    ...
    <div className="space-y-10">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {pedidos.map(p => {
          ...
          const isLate = elapsed > (p.prep_time_minutes || 15);
