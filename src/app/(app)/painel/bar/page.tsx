...
import { GlassWater, Clock, History, Loader2, MapPin, CheckCircle2, Play, RefreshCw, AlertTriangle } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Badge variant="outline" className="h-10 px-4 gap-2 font-black uppercase text-xs border-cyan-200 bg-cyan-50 text-cyan-600">
            <GlassWater className="h-4 w-4" /> {pedidos.length} Pedidos Ativos
          </Badge>
        </div>
      </div>
