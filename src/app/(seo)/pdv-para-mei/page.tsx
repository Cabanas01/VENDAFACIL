      ...
      content={
        <div className="space-y-10">
          <section>
            ...
            <p>Um <strong>PDV para MEI</strong> como o VendaFácil permite que você organize seu negócio em poucos minutos, garantindo que você tenha os dados necessários para sua gestão e declaração anual.</p>
          </section>
          <section>
