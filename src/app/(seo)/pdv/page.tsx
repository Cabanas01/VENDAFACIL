      ...
      content={
        <div className="space-y-12">
          <section>
            ...
            <p>A sigla <strong>PDV</strong> significa <strong>Ponto de Venda</strong>. No sentido mais amplo, é o local onde uma transação comercial é concluída. Historicamente, o PDV era apenas o balcão da loja onde ficava a caixa registradora. Em 2024, o PDV evoluiu para ser um ecossistema completo de gestão.</p>
            <p>Um sistema de PDV moderno não apenas "passa as compras", mas integra o controle de estoque, a gestão de clientes, o fluxo de caixa e a inteligência de dados em uma única interface.</p>
          </section>
